...
<body>
	...
	<div class="header-top-strip" id="gotop">
		<div class="container">
		...
		<div class="main-content">
				...
				<div id="defaultmenu" class="navbar-collapse collapse">
							...
							<ul class="dropdown-menu fullwidth">
								<li class="w3_megamenu-content">
									<div class="row">
										...
										<a
											href="${pageContext.request.contextPath }/movie-single2d.jsp">
											<div class="col-sm-4">
					...
					<ul class="nav navbar-nav navbar-right">
						<li class=""><a
							...
							class="dropdown-toggle">我的</b></a> <!--     <ul class="dropdown-menu">
                            <li>
			...
			<div class="events-section">
				...
				<div class="event-slider">
					<div class="callbacks_container">
						<ul class="rslides" id="slider">
							<li><img
								src="${pageContext.request.contextPath }/images/event-1.jpg"
								alt="" />
								<div class="caption">
									...
									<a class="more"
										href="${pageContext.request.contextPath }/events-ticket-booking.jsp">Register
										Now</a>
								</div></li>
							<li><img
								src="${pageContext.request.contextPath }/images/event-2.jpg"
								alt="" />
								<div class="caption">
									<h2>It is a long established fact that a reader will be
										distracted by the readable.</h2>
									<p>Explore the beautiful Himalayas!</p>
									<a class="more"
										href="${pageContext.request.contextPath }/events-ticket-booking.jsp">Register
										Now</a>
							...
							<li><img
								src="${pageContext.request.contextPath }/images/event-3.jpg"
								alt="" />
								<div class="caption">
									<h2>Contrary to popular belief, Lorem Ipsum is not simply
										random text. It has roots.</h2>
									<p>Explore the beautiful Himalayas!</p>
									<a class="more"
										href="${pageContext.request.contextPath }/events-ticket-booking.jsp">Register
										Now</a>
				...
				<div class="event-search">
					<form>
						<input type="text" value="Search for venue or plays"
							onfocus="this.value = '';"
							onblur="if (this.value == '') {this.value = 'Search for venue or plays';}">
						...
						<div class="bs-example bs-example-tabs" role="tabpanel"
							...
							<ul id="myTab" class="nav nav-tabs" role="tablist">
								...
								<li role="presentation"><a href="#profile" role="tab"
									id="profile-tab" data-toggle="tab" aria-controls="profile">Tomorrow</a></li>
								<li role="presentation"><a href="#profile" role="tab"
									id="profile-tab" data-toggle="tab" aria-controls="profile">This
										Weekend</a></li>
							</ul>
							<div id="myTabContent" class="tab-content">
								<div role="tabpanel" class="tab-pane fade in active" id="home"
									...
									<div class="events-grids">
										<div class="col-md-4 event-grid">
											<a
												href="${pageContext.request.contextPath }/event-single.jsp"><img
											...
											<div class="event-info">
												...
												<div class="clearfix"></div>
												<a class="buy" href="events-ticket-booking.jsp">buy
													tickets</a>
											</div>
										</div>
										<div class="col-md-4 event-grid">
											...
											<div class="event-info">
												...
												<div class="clearfix"></div>
												<a class="buy"
													href="${pageContext.request.contextPath }/events-ticket-booking.jsp">buy
													tickets</a>
											</div>
										</div>
										<div class="col-md-4 event-grid">
										...
										<div class="col-md-4 event-grid">
											<a
												href="${pageContext.request.contextPath }/event-single.jsp"><img
												src="${pageContext.request.contextPath }/images/e5.jpg"
												alt="" /></a>
											<div class="event-info">
												<a class="m-movie-link" href="#">Ladakh Expedition 2015</a>
												<span>Leh</span>
								...
								<div role="tabpanel" class="tab-pane fade" id="profile"
									...
									<div class="col-md-4 event-grid">
										<a href="${pageContext.request.contextPath }/event-single.jsp"><img
											src="${pageContext.request.contextPath }/images/e4.jpg"
											alt="" /></a>
										<div class="event-info">
											<a class="m-movie-link" href="#">Ladakh Expedition 2015</a> <span>Leh</span>
											<p>
												<label>This weekend</label> 4 Jul - 5 Sep
											</p>
											<a class="e-green" href="#">Adventure</a>
