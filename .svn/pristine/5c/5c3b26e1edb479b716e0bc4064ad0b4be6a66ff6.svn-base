		...
		<div class="header-top-strip" id="home">
			<div class="container">
				<div class="header-top-left">
					<p><a href="${pageContext.request.contextPath }/support.jsp">24/7 Customer Care</a> | <a class="play-icon popup-with-zoom-anim" href="#small-dialog" href="#"> Resend Booking Confirmation</a> </p>
...
$('#myModal').modal('no');
		...
		<div class="container">
		  <div class="main-content">
			<div class="header">
				<div class="logo">
					<a href="${pageContext.request.contextPath }/index.jsp"><h1>My Show</h1></a>
				</div>
				<div class="search">
					<div class="search2">
					  <form>
	...
	<div class="bootstrap_container">
            <nav class="navbar navbar-default w3_megamenu" role="navigation">
                <div class="navbar-header">
          			<button type="button" data-toggle="collapse" data-target="#defaultmenu" class="navbar-toggle"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a href="${pageContext.request.contextPath }/index.jsp" class="navbar-brand"><i class="fa fa-home"></i></a>
            ...
            <div id="defaultmenu" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <!-- Mega Menu -->
					<li class="dropdown w3_megamenu-fw active"><a href="${pageContext.request.contextPath }/movies.jsp" data-toggle="dropdown" class="dropdown-toggle">Movies<b class="caret"></b></a>
                        <ul class="dropdown-menu fullwidth">
                            <li class="w3_megamenu-content">
                                <div class="row">
								<h5 class="movies-page">for movies page - <a href="${pageContext.request.contextPath }/movies.jsp">Click here</a> </h5>
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-4 movie-dd">
										...
										<p><a href="${pageContext.request.contextPath }/movie-single.jsp">ABCD 2 (3D) (4DX)</a><span>... (Tomorrow, 19 Jun)</span></p>
										<p><a href="${pageContext.request.contextPath }/movie-single.jsp">ABCD 2 (3D) (4DX)</a><span>... (Tomorrow, 19 Jun)</span></p>
										<p><a href="${pageContext.request.contextPath }/movie-single.jsp">ABCD 2 (3D) (4DX)</a><span>... (Tomorrow, 19 Jun)</span></p>
										<p><a href="${pageContext.request.contextPath }/movie-single.jsp">ABCD 2 (3D) (4DX)</a><span>... (Tomorrow, 19 Jun)</span></p>
										<p><a href="${pageContext.request.contextPath }/movie-single.jsp">ABCD 2 (3D) (4DX)</a><span>... (Tomorrow, 19 Jun)</span></p>
									...
									<div class="menu-featured-movies">
										...
										<div class="col-md-2 menu-featured-movies-img">
											<a href="${pageContext.request.contextPath }/movie-single.jsp"><img src="${pageContext.request.contextPath }/images/mf1.jpg" alt="" /></a>
										</div>
										<div class="col-md-2 menu-featured-movies-img">
											<a href="${pageContext.request.contextPath }/movie-single.jsp"><img src="${pageContext.request.contextPath }/images/mf2.jpg" alt="" /></a>
										</div>
										<div class="col-md-2 menu-featured-movies-img">
											<a href="${pageContext.request.contextPath }/movie-single.jsp"><img src="${pageContext.request.contextPath }/images/mf3.jpg" alt="" /></a>
										</div>
										<div class="col-md-2 menu-featured-movies-img">
											<a href="${pageContext.request.contextPath }/movie-single.jsp"><img src="${pageContext.request.contextPath }/images/mf3.jpg" alt="" /></a>
										</div>
					...
					<li class="dropdown w3_megamenu-fw"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Events<b class="caret"></b></a>
                        <ul class="dropdown-menu half">
                            <li class="w3_megamenu-content withdesc">
                                <div class="row">
					<h5 class="movies-page">for events page - <a href="${pageContext.request.contextPath }/events.jsp">Click here</a> </h5>
								<h3 class="title">Featured Events</h3>
                                    <div class="col-sm-3">
                                    	<div class="e-movie">
								<div class="e-movie-img">
									<a href="${pageContext.request.contextPath }/events.jsp"><img src="${pageContext.request.contextPath }/images/f2.jpg" alt="" /></a>
								</div>
								<div class="e-buy-tickets">
                                    ...
                                    <div class="col-sm-3">
                                    	<div class="e-movie">
								<div class="e-movie-img">
									<a href="${pageContext.request.contextPath }/events.jsp"><img src="${pageContext.request.contextPath }/images/f3.jpg" alt=""></a>
								</div>
								<div class="e-buy-tickets">
									<a href="${pageContext.request.contextPath }/event-payment.jsp">BUY TICKETS</a>
								</div>
                                    ...
                                    <div class="col-sm-3">
                                    	<div class="e-movie">
								<div class="e-movie-img">
									<a href="${pageContext.request.contextPath }/events.jsp"><img src="${pageContext.request.contextPath }/images/f4.jpg" alt="" /></a>
								</div>
								<div class="e-buy-tickets">
									<a href="${pageContext.request.contextPath }/event-payment.jsp">BUY TICKETS</a>
								</div>
                                    ...
                                    <div class="col-sm-3">
                                    	<div class="e-movie">
								<div class="e-movie-img">
									<a href="${pageContext.request.contextPath }/events.jsp"><img src="${pageContext.request.contextPath }/images/f1.jpg" alt="" /></a>
								</div>
								<div class="e-buy-tickets">
									<a href="${pageContext.request.contextPath }/event-payment.jsp">BUY TICKETS</a>
								</div>
...
<!-- AddThis Smart Layers END -->
		 ...
		 <div class="banner col-md-8">
			<section class="slider">
				<div class="flexslider">
						...
						<li>
							<img src="${pageContext.request.contextPath }/images/pic3.jpg" class="img-responsive" alt="" />
						</li>
						<li>
							<img src="${pageContext.request.contextPath }/images/pic4.jpg" class="img-responsive" alt="" />
						</li>
				  </ul>
				</div>
					</section>
				...
				<div class="slider1">
						   <div class="callbacks_container">
							  <ul class="rslides" id="slider">
								 ...
								 <li>	          
									 <iframe  src="https://www.youtube.com/embed/62E4FJTwSuc" frameborder="0" allowfullscreen></iframe>		          
								 </li>
								 <li>	          
									 <iframe src="https://www.youtube.com/embed/vyX4toD395U" frameborder="0" allowfullscreen></iframe>	          
								 </li>
							  </ul>
						  </div>
				</div>
	...
	<div class="now-showing-movies">
		...
		<div class="col-md-4 movie-preview">
			<a href="${pageContext.request.contextPath }/movie-single.jsp" class="mask">
				<img src="${pageContext.request.contextPath }/images/m1.jpg" class="img-responsive zoom-img" alt="" />
				<div class="m-movie-title">
					<a class="m-movie-link" href="${pageContext.request.contextPath }/movie-single.jsp">Where Is Vidya Balan (A)</a>
					<div class="clearfix"></div>
					<div class="m-r-date">
						<p><i class="fa fa-calendar-o"></i>26 Jun, 2015</p>
						<a href="${pageContext.request.contextPath }/movie-select-show.jsp">book now</a>
					</div>
					<div class="m-r-like">
		...
		<div class="col-md-4 movie-preview">
			<a href="${pageContext.request.contextPath }/movie-single.jsp" class="mask">
				<img src="${pageContext.request.contextPath }/images/m2.jpg" class="img-responsive zoom-img" alt="" />
				<div class="m-movie-title">
					<a class="m-movie-link" href="${pageContext.request.contextPath }/movie-single.jsp">Krishnamma Kalipindi Iddarini (U/A)</a>
					<div class="clearfix"></div>
					<div class="m-r-date">
		...
		<div class="col-md-4 movie-preview">
			<a href="${pageContext.request.contextPath }/movie-single.jsp" class="mask">
				<img src="${pageContext.request.contextPath }/images/m3.jpg" class="img-responsive zoom-img" alt="" />
				<div class="m-movie-title">
					<a class="m-movie-link" href="${pageContext.request.contextPath }/movie-single.jsp">Kerintha (U)</a>
					<div class="clearfix"></div>
					<div class="m-r-date">
		...
		<div class="col-md-4 movie-preview">
			<a href="${pageContext.request.contextPath }/movie-single.jsp" class="mask">
				<img src="${pageContext.request.contextPath }/images/m4.jpg" class="img-responsive zoom-img" alt="" />
				<div class="m-movie-title">
		...
		<div class="col-md-4 movie-preview">
			<a href="${pageContext.request.contextPath }/movie-single.jsp" class="mask">
				<img src="${pageContext.request.contextPath }/images/m5.jpg" class="img-responsive zoom-img" alt="" />
				<div class="m-movie-title">
					<a class="m-movie-link" href="${pageContext.request.contextPath }/movie-single.jsp">Insidious: Chapter 3 (A)</a>
					<div class="clearfix"></div>
					<div class="m-r-date">
		...
		<div class="col-md-4 movie-preview">
			<a href="${pageContext.request.contextPath }/movie-single.jsp" class="mask">
				<img src="${pageContext.request.contextPath }/images/m6.jpg" class="img-responsive zoom-img" alt="" />
				<div class="m-movie-title">
					<a class="m-movie-link" href="${pageContext.request.contextPath }/movie-single.jsp">Jurassic World (3D) (U/A)</a>
					<div class="clearfix"></div>
					<div class="m-r-date">
	...
	<div class="now-showing-movies">
		...
		<div class="col-md-4 movie-preview">
			<a href="${pageContext.request.contextPath }/movie-single.jsp" class="mask">
				<img src="${pageContext.request.contextPath }/images/m7.jpg" class="img-responsive zoom-img" alt="" />
				<div class="m-movie-title">
					<a class="m-movie-link" href="${pageContext.request.contextPath }/movie-single.jsp">Magic Mike XXL</a>
					<div class="clearfix"></div>
					<div class="m-r-date">
		...
		<div class="col-md-4 movie-preview">
			<a href="${pageContext.request.contextPath }/movie-single.jsp" class="mask">
				<img src="${pageContext.request.contextPath }/images/m8.jpg" class="img-responsive zoom-img" alt="" />
				<div class="m-movie-title">
					<a class="m-movie-link" href="${pageContext.request.contextPath }/movie-single.jsp">Amy</a>
					<div class="clearfix"></div>
					<div class="m-r-date">
		...
		<div class="col-md-4 movie-preview">
			<a href="${pageContext.request.contextPath }/movie-single.jsp" class="mask">
				<img src="${pageContext.request.contextPath }/images/m9.jpg" class="img-responsive zoom-img" alt="" />
				<div class="m-movie-title">
					<a class="m-movie-link" href="${pageContext.request.contextPath }/movie-single.jsp">Baby</a>
					<div class="clearfix"></div>
					<div class="m-r-date">
						<p><i class="fa fa-calendar-o"></i>3 Jul, 2015</p>
					</div>
		...
		<div class="col-md-4 movie-preview">
			<a href="${pageContext.request.contextPath }/movie-single.jsp" class="mask">
				<img src="${pageContext.request.contextPath }/images/m10.jpg" class="img-responsive zoom-img" alt="" />
				<div class="m-movie-title">
					<a class="m-movie-link" href="${pageContext.request.contextPath }/movie-single.jsp">Bezubaan Ishq (U)</a>
					<div class="clearfix"></div>
					<div class="m-r-date">
						<p><i class="fa fa-calendar-o"></i>3 Jul, 2015</p>
					</div>
		...
		<div class="col-md-4 movie-preview">
			<a href="${pageContext.request.contextPath }/movie-single.jsp" class="mask">
				<img src="${pageContext.request.contextPath }/images/m11.jpg" class="img-responsive zoom-img" alt="" />
				<div class="m-movie-title">
					<a class="m-movie-link" href="${pageContext.request.contextPath }/movie-single.jsp">Guddu Rangeela (U/A)</a>
					<div class="clearfix"></div>
					<div class="m-r-date">
						<p><i class="fa fa-calendar-o"></i>3 Jul, 2015</p>
					</div>
		...
		<div class="col-md-4 movie-preview">
			<a href="${pageContext.request.contextPath }/movie-single.jsp" class="mask">
				<img src="${pageContext.request.contextPath }/images/m12.jpg" class="img-responsive zoom-img" alt="" />
				<div class="m-movie-title">
					<a class="m-movie-link" href="${pageContext.request.contextPath }/movie-single.jsp">James Bond</a>
					<div class="clearfix"></div>
					<div class="m-r-date">
						<p><i class="fa fa-calendar-o"></i>3 Jul, 2015</p>
					</div>
		...
		<div class="col-md-4 movie-preview">
			<a href="${pageContext.request.contextPath }/movie-single.jsp" class="mask">
				<img src="${pageContext.request.contextPath }/images/m13.jpg" class="img-responsive zoom-img" alt="" />
				<div class="m-movie-title">
		...
		<div class="col-md-4 movie-preview">
			<a href="${pageContext.request.contextPath }/movie-single.jsp" class="mask">
				<img src="${pageContext.request.contextPath }/images/m14.jpg" class="img-responsive zoom-img" alt="" />
				<div class="m-movie-title">
					<a class="m-movie-link" href="${pageContext.request.contextPath }/movie-single.jsp">Online Binline</a>
					<div class="clearfix"></div>
					<div class="m-r-date">
						<p><i class="fa fa-calendar-o"></i>3 Jul, 2015</p>
					</div>
		...
		<div class="col-md-4 movie-preview">
			<a href="${pageContext.request.contextPath }/movie-single.jsp" class="mask">
				<img src="${pageContext.request.contextPath }/images/m15.jpg" class="img-responsive zoom-img" alt="" />
				<div class="m-movie-title">
					<a class="m-movie-link" href="${pageContext.request.contextPath }/movie-single.jsp">Oru Thozan Oru Thozi</a>
					<div class="clearfix"></div>
					<div class="m-r-date">
						<p><i class="fa fa-calendar-o"></i>3 Jul, 2015</p>
					</div>
							    ...
							    <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
									<ul class="tab_img">
									  <li>
										<div class="view view-first">
					   		  			  <a href="${pageContext.request.contextPath }/movie-select-show.jsp"> <img src="${pageContext.request.contextPath }/images/pic-1.jpg" class="img-responsive" alt=""/></a>
										   <div class="info1"> </div>
											 <div class="mask">
						                     </div>
								              <div class="tab_desc">
									  ...
									  <li>
										<div class="view view-first">
					   		  			   <a href="${pageContext.request.contextPath }/movie-select-show.jsp"><img src="${pageContext.request.contextPath }/images/pic-2.jpg" class="img-responsive" alt=""/></a>
										   <div class="info1"> </div>
											 <div class="mask">
						                     </div>
								              <div class="tab_desc">
									  ...
									  <li>
										<div class="view view-first">
					   		  			   <a href="${pageContext.request.contextPath }/movie-select-show.jsp"><img src="${pageContext.request.contextPath }/images/pic-10.jpg" class="img-responsive" alt=""/></a>
											 <div class="mask">
						                        <div class="info1"> </div>
								              </div>
								                <div class="tab_desc">
							     ...
							     <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
									<ul class="tab_img">
									  <li>
										<div class="view view-first">
					   		  			   <a href="${pageContext.request.contextPath }/movie-select-show.jsp"><img src="${pageContext.request.contextPath }/images/pic-8.jpg" class="img-responsive" alt=""/></a>
											 <div class="mask">
						                        <div class="info1"> </div>
								              </div>
								                <div class="tab_desc">
									  ...
									  <li>
										<div class="view view-first">
					   		  			  <a href="${pageContext.request.contextPath }/movie-select-show.jsp"> <img src="${pageContext.request.contextPath }/images/pic-3.jpg" class="img-responsive" alt=""/></a>
											 <div class="mask">
						                        <div class="info1"> </div>
								              </div>
								                <div class="tab_desc">
										...
										<li class="last">
										  <div class="view view-first">
					   		  			   <a href="${pageContext.request.contextPath }/movie-select-show.jsp"><img src="${pageContext.request.contextPath }/images/pic-9.jpg" class="img-responsive" alt=""/></a>
											 <div class="mask">
						                        <div class="info1"> </div>
								              </div>
								               <div class="tab_desc">
							     ...
							     <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
									<ul class="tab_img">
										<li>
										  <div class="view view-first">
					   		  			  <a href="${pageContext.request.contextPath }/movie-select-show.jsp"> <img src="${pageContext.request.contextPath }/images/pic-4.jpg" class="img-responsive" alt=""/></a>
											 <div class="mask">
						                        <div class="info1"> </div>
								              </div>
								                <div class="tab_desc">
										...
										<li>
										  <div class="view view-first">
					   		  			  <a href="${pageContext.request.contextPath }/movie-select-show.jsp"> <img src="${pageContext.request.contextPath }/images/pic-12.jpg" class="img-responsive" alt=""/></a>
											 <div class="mask">
						                        <div class="info1"> </div>
								              </div>
								                <div class="tab_desc">
										...
										<li class="last">
										  <div class="view view-first">
					   		  			   <a href="${pageContext.request.contextPath }/movie-select-show.jsp"><img src="${pageContext.request.contextPath }/images/pic-5.jpg" class="img-responsive" alt=""/></a>
											 <div class="mask">
						                        <div class="info1"> </div>
								              </div>
								                <div class="tab_desc">
							     ...
							     <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-3">
									<ul class="tab_img">
									  <li>
										<div class="view view-first">
					   		  			  <a href="${pageContext.request.contextPath }/movie-select-show.jsp"> <img src="${pageContext.request.contextPath }/images/pic-6.jpg" class="img-responsive" alt=""/></a>
											 <div class="mask">
						                        <div class="info1"> </div>
								              </div>
								                <div class="tab_desc">
			...
			<div class="right-side-bar">
				<div class="top-movies-in-india">
					...
					<ul class="mov_list">
						...
						<li>77%</li>
						<li><a href="${pageContext.request.contextPath }/movie-single.jsp">Jurassic World (3D) (U/A)</a></li>
					</ul>
					<ul class="mov_list">
						<li><i class="fa fa-star"></i></li>
						<li>80%</li>
						<li><a href="${pageContext.request.contextPath }/movie-single.jsp">Jurassic World (3D Hindi) (U/A)</a></li>
					</ul>
					<ul class="mov_list">
						<li><i class="fa fa-star"></i></li>
						<li>69%</li>
						<li><a href="${pageContext.request.contextPath }/movie-single.jsp">Dil Dhadakne Do (U/A)</a></li>
					</ul>
					<ul class="mov_list">
						<li><i class="fa fa-star"></i></li>
						<li>65%</li>
						<li><a href="${pageContext.request.contextPath }/movie-single.jsp">Hamari Adhuri Kahani (U)</a></li>
					</ul>
					<ul class="mov_list">
						<li><i class="fa fa-star"></i></li>
						<li>83%</li>
						<li><a href="${pageContext.request.contextPath }/movie-single.jsp">Premam (U)</a></li>
					</ul>
					<ul class="mov_list">
						<li><i class="fa fa-star"></i></li>
						<li>87%</li>
						<li><a href="${pageContext.request.contextPath }/movie-single.jsp">Tanu Weds Manu Returns (U/A)</a></li>
					</ul>
					<ul class="mov_list">
						<li><i class="fa fa-star"></i></li>
						<li>71%</li>
						<li><a href="${pageContext.request.contextPath }/movie-single.jsp">Romeo Juliet (U)</a></li>
					</ul>
					<ul class="mov_list">
						<li><i class="fa fa-star"></i></li>
						<li>81%</li>
						<li><a href="${pageContext.request.contextPath }/movie-single.jsp">Jurassic World (IMAX 3D) (U/A)</a></li>
					</ul>
					<ul class="mov_list">
						<li><i class="fa fa-star"></i></li>
						<li>80%</li>
						<li><a href="${pageContext.request.contextPath }/movie-single.jsp">Jurassic World (2D Hindi) (U/A)</a></li>
					</ul>
					<ul class="mov_list">
						<li><i class="fa fa-star"></i></li>
						<li>89%</li>
						<li><a href="${pageContext.request.contextPath }/movie-single.jsp">Kaaka Muttai (U)</a></li>
					</ul>
				</div>
				<div class="quick-pay">
					<h3>Quick Pay</h3>
	...
	<div class="footer-top-strip">
			<p><span>Next Change <i>(Friday, 19 Jun) </i>: </span><a href="${pageContext.request.contextPath }/movie-single.jsp">Disney's ABCD 2 (3D) (U)</a>, <a href="${pageContext.request.contextPath }/movie-single.jsp"> 2 Premi Premache</a> , <a href="${pageContext.request.contextPath }/movie-single.jsp">Dekh Ke (Bhojpuri)</a> , <a href="${pageContext.request.contextPath }/movie-single.jsp">Disney's ABCD 2 (2D) (U)</a>, <a href="${pageContext.request.contextPath }/movie-single.jsp">Dekh Ke (Bhojpuri)</a></p>
			<p><span>Coming Soon :</span><a href="${pageContext.request.contextPath }/movie-single.jsp"> 2 Premi Premache</a>, <a href="${pageContext.request.contextPath }/movie-single.jsp">Acharam, Dekh Ke (Bhojpuri)</a>, <a href="${pageContext.request.contextPath }/movie-single.jsp">Entourage</a>, <a href="${pageContext.request.contextPath }/movie-single.jsp">Kuttram Kadithal</a></p>
		</div>
