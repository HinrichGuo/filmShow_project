...
<div class="error-page" id="error-page_zw">
	<div id="pai" class="leftxz" style="height:420px;">
		<!-- <div class="div_pai"><span style="color:#808080;">一排</span></div>
		<div class="div_pai"><span style="color:#808080;">二排</span></div>
		<div class="div_pai"><span style="color:#808080;">三排</span></div>
		<div class="div_pai"><span style="color:#808080;">四排</span></div>
		<div class="div_pai"><span style="color:#808080;">五排</span></div>
		<div class="div_pai"><span style="color:#808080;">六排</span></div>
		<div class="div_pai"><span style="color:#808080;">七排</span></div>
		<div class="div_pai"><span style="color:#808080;">八排</span></div>
		<div class="div_pai"><span style="color:#808080;">九排</span></div>
		<div class="div_pai"><span style="color:#808080;">十排</span></div> -->
	</div>
	<div id="div_zw_content" class="leftxz" style="height:100%;width:55%;">
		<div class="header" >
				<div class="pm" >
					<img id="pingmu" src="${pageContext.request.contextPath }/images/屏幕.png"/>
				</div>
				<div class="clearfix"></div>
		</div>
...
function fun_zw(){
	for(var i=0;i<=14;i++){
		for(var j=0;j<=10;j++){
			document.write("<div class=\"div_zw1\" style=\"width:5%;height:6%;margin-left:0.1%;margin-top:0.5%;\" >");
			document.write("<img id=\"test1\" class=\"myImg\" src=\"${pageContext.request.contextPath }/images/座位01.png\" title=\"i行j列\" onclick=\"fun_1()\" ondblclick=\"fun_2()\"/>");
			document.write("</div>");
			/* var imgEl= document.getElementsByTagName("img");
			imgEl.setAttribute("class","i");  */
		}
	} 
}
fun_zw();
function fun_1(){
	//① 实现图片更换，找到源文件元素 img 
	var imgEl = document.getElementById("test1");
	//② 获取元素的 src 属性
	var srcVal = imgEl.getAttribute("src");
	//alert(srcVal);
	//③ 更换 src 值
	imgEl.setAttribute("src","images/座位02.png");
}
function fun_2(){
	var imgEl = document.getElementById("test1");
	var srcVal = imgEl.getAttribute("src");
	imgEl.setAttribute("src","images/座位01.png");
}
</script>
	<div id="seat_kind">
		<div id="sele_yes" class="sele">
			<img alt="" src="images/座位01.png" style="width:50%;height:50%">可选
		</div>
		<div id="sele_no" class="sele">
			<img alt="" src="images/座位03.png" style="width:40%;height:40%">不可选
		</div>
		<div id="sele_done" class="sele">
			<img alt="" src="images/座位02.png" style="width:50%;height:50%">已选
		</div>
	</div>
	</div>
	<form action="payment" method="post">
	<div id="div_ticket" class="leftxz">
		<div id="div_ticket_head"> 电影票</div>
		<div id="div_ticket_img">
			<div id="div_ticket_img_left" class="ticket_tow">
				<img alt="" src="images/票默认.png" style="width:100%;height:100%;">
			</div>
			<div id="div_ticket_img_right" class="ticket_tow">
				<br><input type="text" value="《影片名称》" readOnly><br><br>
				<input type="text" value="动作/喜剧" readOnly>
			</div>
		</div>
		<div id="div_ticket_center">
			<br><label>影院：</label><input type="text" value="万达影院康桥国际店" readOnly><br><br>
			<label>放映类型：</label><input type="text" value="3D" readOnly><br><br>
			<label>场次：</label><input type="text" value="3月31 15：28" readOnly><br><br>
			<label>座位：</label><input type="text" value="10排2座" readOnly><br><br>
			<label>票数：</label><input type="text" value="2" readOnly><br><br>
			<label>票价：</label><input type="text" value="60" readOnly><br><br>
		</div>
		<div id="div_ticket_foot">
			<label>总计：</label><input type="text" value="120" readOnly><br>
			<!-- <input type="submit"  value="预订位置"> -->
		</div>
	</div>
	</form>
	</div>
