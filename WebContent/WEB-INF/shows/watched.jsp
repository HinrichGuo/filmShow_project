...
$('#myModal').modal('no');
		...
		<div class="container">
		  <div class="main-content">
			<div class="header">
				<div class="logo">
					<a href="${pageContext.request.contextPath }/index.jsp"><h1>我的地盘</h1></a>
				</div>
				<div class="search">
					<div class="search2">
					  <form>
	...
	<div class="bootstrap_container">
            ...
            <div id="defaultmenu" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <!-- Mega Menu -->
					<li class="dropdown w3_megamenu-fw active"><a href="${pageContext.request.contextPath }/movies.jsp" data-toggle="dropdown" class="dropdown-toggle">看过的电影</a>
                       
                    </li>
					<li class="dropdown w3_megamenu-fw"><a href="#" data-toggle="dropdown" class="dropdown-toggle">电影票</a>
...
<!-- AddThis Smart Layers END -->
		...
		<div class="person-grids">
			...
			<div class="col-md-6 person-grids-left">
				<div class="person-grid">
					<div class="person-img" style="height:120px;">
						<a href="#"><img src="${pageContext.request.contextPath }/images/75x75.jpg" title="actor"></a>
					</div>
					...
					<div style="height:120px;float: left;">
						...
						<div style="height:120px;float: right;">
						<a href="#"><div style="background-color:#ff862d; width:50px;border-radius: 25%;text-align: center;float: right;color:#000000;font-size:16px;margin: 20px 0px 5px;">
            评分
        </div></a>
       
						
						 <a href="#"><div style="background-color:#1b8ee2; width:50px;border-radius: 25%;text-align: center;float: right;color:#000000;font-size:16px;margin: 5px 0px 10px;">
            清除
        </div></a>
						</div>
			...
			<div class="col-md-6 person-grids-right">
	...
	<div class="clearfix"></div>
		...
		<p><span>Showing in cities : </span><a href="${pageContext.request.contextPath }/movies.jsp">Bengaluru</a>, <a href="${pageContext.request.contextPath }/movies.jsp">Hyderabad</a>, <a href="${pageContext.request.contextPath }/movies.jsp">Khammam</a>, <a href="${pageContext.request.contextPath }/movies.jsp">Kurnool</a>, <a href="${pageContext.request.contextPath }/movies.jsp">Nizamabad</a>, <a href="${pageContext.request.contextPath }/movies.jsp">Vijayawada</a>, <a href="#">Vizag</a>, <a href="${pageContext.request.contextPath }/movies.jsp">Vizianagaram</a>, <a href="${pageContext.request.contextPath }/movies.jsp">Warangal</a></p>
		<p><span>Cinemas Nearby : </span><a href="${pageContext.request.contextPath }/movie-single.jsp"> INOX: Jyoti Mall, Kurnool </a>|
		...
		<!-- <div class="footer">
			<div class="col-md-3 footer-left">
				<div class="f-mov-list">
					<h4>Latest Movies</h4>
					<ul>
						<li><a href="now-showing.jsp">Now Showing</a></li>
						<li><a href="comming-soon.jsp">Coming Soon</a></li>
						<li><a href="watched.jsp">Movie Celebrities</a></li>
					</ul>
					<div class="clearfix"></div>
				</div>
				<div class="f-mov-list">
			...
			<div class="col-md-3 footer-left">
				<div class="f-mov-list">
					...
					<ul>
						<li><a href="regions.jsp">All Regions</a></li>
						<li><a href="cinema-chain.jsp">Cinema Chains</a></li>
						<li><a href="cinemas.jsp">Cinemas</a></li>						
					</ul>
					<div class="clearfix"></div>
				</div>
				<div class="f-mov-list">
			...
			<div class="col-md-3 footer-left">
				<div class="f-mov-list">
					<h4>Exclusives</h4>
					<ul>
						<li><a href="donate.jsp">Book A Smile</a></li>
						<li><a href="vochers.jsp">Corporate Vouchers</a></li>
			...
			<div class="col-md-3 footer-left">
				<div class="f-mov-list">
					...
					<ul>
						...
						<li><a href="movies.jsp">Romance</a></li>
						<li><a href="movies.jsp">Comedy</a></li>
						<li><a href="movies.jsp">Adult</a></li>
			...
			<div class="footer-right">
				...
				<div class="recent_24by7">
					...
					<a href="support.jsp"><i class="fa fa-question"></i>24/7 Customer Care</a>
				</div>
					<div class="clearfix"></div>
			</div>
			</div>
