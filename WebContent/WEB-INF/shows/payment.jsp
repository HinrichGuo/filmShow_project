...
<script src="${pageContext.request.contextPath }/https://oss.maxcdn.com/libs/respond.js/1.3.0/respond.min.js"></script>
<![endif]-->
	...
	<div class="bootstrap_container">
            ...
            <div id="defaultmenu" class="navbar-collapse collapse">
                 <ul class="nav navbar-nav">
                    ...
                    <!-- Mega Menu -->
					<li class="dropdown w3_megamenu-fw"><a href="${pageContext.request.contextPath }/movies.jsp" data-toggle="dropdown" class="dropdown-toggle">类型<b class="caret"></b></a>
				...
				<ul class="nav navbar-nav navbar-right">
					<li class=""><a href="${pageContext.request.contextPath }/about.jsp" class="dropdown-toggle">我的</b></a>
				...
				<div class="payment-options">
					...
					<div class="tab-grids event-tab-grids">
						<div id="tab1" class="tab-grid">
							<img src="${pageContext.request.contextPath }/images/payment.png" alt="payment" />
				...
				<div class="c-lang">
					...
					<label class="lang">KOTAK bank</label>
						...
						<div id="tab4" class="tab-grid">
							<div class="row">
                        <div class="col-md-6">
                            <img class="pp-img" src="${pageContext.request.contextPath }/images/paypal.png" alt="Image Alternative text" title="Image Title">
