...
$('#myModal').modal('no');
	...
	<div class="bootstrap_container">
            ...
            <div id="defaultmenu" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <!-- Mega Menu -->
					<li class="dropdown w3_megamenu-fw active"><a href="${pageContext.request.contextPath }/movies.jsp" data-toggle="dropdown" class="dropdown-toggle">类型<b class="caret"></b></a>
                        <ul class="dropdown-menu fullwidth">
                            <li class="w3_megamenu-content">
                                <div class="row">
								<h5 class="movies-page">for movies page - <a href="${pageContext.request.contextPath }/movies.jsp">Click here</a> </h5>
                                   <a href="${pageContext.request.contextPath }/movie-single2d.jsp"> <div class="col-sm-4">
					...
					<ul class="mov_list">
						...
						<li><a href="movie-single.jsp">Hamari Adhuri Kahani (U)</a></li>
                                   ...
                                   <a href="${pageContext.request.contextPath }/movie-single3d.jsp"> <div class="col-sm-4 movie-dd">
                                   ...
                                   <a href="${pageContext.request.contextPath }/movie-single.jsp"> <div class="col-sm-4 movie-dd">
					...
					<li class="dropdown w3_megamenu-fw"><a href="#" data-toggle="dropdown" class="dropdown-toggle">影院选择<b class="caret"></b></a>
	...
	<li><a href="${pageContext.request.contextPath }/press.jsp">Press Coverage</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown"><a href="${pageContext.request.contextPath }/about.jsp" class="dropdown-toggle">我的<b class="caret"></b></a>
                        <!-- <ul class="dropdown-menu">
                            <li>
...
<!-- AddThis Smart Layers END -->
	...
	<div class="m-single-article">
		<div class="article-left">
			<h3>3D电影推荐<span> <i class="fa fa-heart"></i> 99%</span></h3>
			...
			<div class="article-time-strip">
				...
				<div class="article-img">
					<iframe src="${pageContext.request.contextPath }/https://www.youtube.com/embed/VdafjyFK3ko" frameborder="0" allowfullscreen></iframe>
				</div>
		...
		<div class="article-right">
			...
			<div id="myTabContent" class="tab-content">
			  <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">				  
				 ...
				 <a class="show-time" href="${pageContext.request.contextPath }/movie-select-show.jsp">06:30 PM</a>
				 <div class="clearfix"></div>
				  <a class="more-show-time" href="${pageContext.request.contextPath }/movie-select-show.jsp">More Show Times</a>
			  </div>
			  <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
				 <p class="m-s-t">INOX: Lorem Mall, Chicago</p>
				 <a class="show-time" href="${pageContext.request.contextPath }/movie-select-show.jsp">12:45 PM</a><a class="show-time" href="movie-select-show.jsp">06:30 PM</a>
				 <div class="clearfix"></div>
				 <a class="more-show-time" href="${pageContext.request.contextPath }/movie-select-show.jsp">More Show Times</a>
			  </div>
			</div>
		  ...
		  <div class="response">
						<div class="media response-info">
							<div class="media-left response-text-left">
								<a href="#">
									<img class="media-object" src="${pageContext.request.contextPath }/images/icon1.png" alt="">
								</a>
							...
							<div class="media-body response-text-right">
								...
								<ul>
									<li>MARCH 21, 2015</li>
									<li><a href="${pageContext.request.contextPath }/single.jsp">Reply</a></li>
								</ul>
							</div>
							<div class="clearfix"> </div>
						</div>
	...
	<!-- <div class="footer-top-strip">
		<p><span>Showing in cities : </span><a href="movies.jsp">Bengaluru</a>, <a href="movies.jsp">Hyderabad</a>, <a href="movies.jsp">Khammam</a>, <a href="movies.jsp">Kurnool</a>, <a href="movies.jsp">Nizamabad</a>, <a href="movies.jsp">Vijayawada</a>, <a href="#">Vizag</a>, <a href="movies.jsp">Vizianagaram</a>, <a href="movies.jsp">Warangal</a></p>
		<p><span>Cinemas Nearby : </span><a href="movie-single.jsp"> INOX: Jyoti Mall, Kurnool </a>|
			<p><span>Next Change <i>(Friday, 19 Jun) </i>: </span><a href="movie-single.jsp">Disney's ABCD 2 (3D) (U)</a>, <a href="movie-single.jsp"> 2 Premi Premache</a> , <a href="movie-single.jsp">Dekh Ke (Bhojpuri)</a> , <a href="movie-single.jsp">Disney's ABCD 2 (2D) (U)</a>, <a href="movie-single.jsp">Dekh Ke (Bhojpuri)</a></p>
			<p><span>Coming Soon :</span><a href="movie-single.jsp"> 2 Premi Premache</a>, <a href="movie-single.jsp">Acharam, Dekh Ke (Bhojpuri)</a>, <a href="movie-single.jsp">Entourage</a>, <a href="movie-single.jsp">Kuttram Kadithal</a></p>
		</div> -->
		</div>
		<div class="footer">
